...
class Randomorg:
    ...
    def generateBlobs(self, n, size, format="base64"):
        ...
        return response["result"]["random"]["data"]
print(">>>import Randomorg")
print(">>>r = Randomorg('00000000-0000-0000-0000-000000000000')")
r = Randomorg("00000000-0000-0000-0000-000000000000")
print(">>>r.status()")
print(r.status())
print(">>>r.bitsLeft()")
print(r.bitsLeft())
print(">>>r.requestsLeft()")
print(r.requestsLeft())
print(">>>r.generateIntegers(10,0,1000)")
print(r.generateIntegers(10,0,1000))
print(">>>r.generateGaussians(10,1,1,5)")
print(r.generateGaussians(10,1,1,5))
print(">>>r.generateStrings(10,10,'abcdefghijklmnopqrstuvwxyz',replacement='false')")
print(r.generateStrings(10,10,"abcdefghijklmnopqrstuvwxyz",replacement="false"))
print(">>>r.generateUUIDs(10)")
print(r.generateUUIDs(10))
print(">>>r.generateBlobs(2,128,format='base64')")
print(r.generateBlobs(2,128,format="base64"))